...
export default function ContainerFour() { 
  return (
    <div className='conFour'>
      ...
      <Carousel  className='caro' infiniteLoop={true} useKeyboardArrows={true} emulateTouch={true} swipeable={true} showArrows={false} showStatus={false} showThumbs={false} verticalSwipe={false} >
